...
public class RedisTest {
    ...
    public void testSets() {
        ...
        redisTemplate.opsForSet().add(redisKey, "liubei", "guanyu", "zhangfei", "zhaoyun");
    ...
    public void testSortedSets() {
        ...
        redisTemplate.opsForZSet().add(redisKey, "bajie", 100);
    ...
    public void testKeys() {
        ...
        System.out.println(redisTemplate.hasKey("rest:user"));
